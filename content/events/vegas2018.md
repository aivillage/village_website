...
<table style="width:100%">
  ...
  <tr>
    <td> Saturday </td>
    <td> 17:30 </td>
    <td> INTRO TO DATA MASTERCLASS: Tour-de-ML, Graphs & Anomalies </td>
    <td> Leo Meyerovich & Eugene Teo </td>
    <td> Workshop </td>
  </tr>
  <tr><td colspan="5"></td></tr>
...
##### Wrangling: Digging into trafficking & malware with Jupyter notebooks, Pandas data manipulation, and GPU-accelerated plotting
...
##### Tour-de-ML, Graphs & Anomalies: Classifying DGA domains with Markov Chains and Random Forest, Understanding trafficking & malware events with GPU visual analytics & dimensionality reduction
